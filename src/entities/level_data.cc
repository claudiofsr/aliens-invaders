...
// ==============================================================================
// Theatrical 4-Corner Diagonal Ballet Incursions (Wave 5)
// Four synchronized diagonal paths entering from the 4 outer screen corners,
// diverging well before the center and docking onto the Left/Right Flanks.
// ==============================================================================

// 1. Top-Left Incursion: enters northwest diagonal, dives to baseline and loops up to Left Flank
const FlightPath ballet_x_top_left({
    {-50, -50}, {140, 140}, {260, 260},
    {220, 480}, {160, 720}, {220, 880},
    {340, 840}, {300, 620}, {180, 420}, {180, 220}
});

// 2. Top-Right Incursion: enters northeast diagonal, dives to baseline and loops up to Right Flank
const FlightPath ballet_x_top_right({
    {1074, -50}, {884, 140}, {764, 260},
    {804, 480}, {864, 720}, {804, 880},
    {684, 840}, {724, 620}, {844, 420}, {844, 220}
});

// 3. Bottom-Left Ambush: enters southwest flank, climbs into pirouette, dives, and docks on Left Flank
const FlightPath ballet_x_bottom_left({
    {-50, 920}, {140, 800}, {260, 680},
    {320, 480}, {220, 320}, {140, 400}, {160, 600},
    {280, 820}, {240, 600}, {200, 240}
});

// 4. Bottom-Right Ambush: enters southeast flank, climbs into corkscrew, dives, and docks on Right Flank
const FlightPath ballet_x_bottom_right({
    {1074, 920}, {884, 800}, {764, 680},
    {704, 480}, {804, 320}, {884, 400}, {864, 600},
    {744, 820}, {784, 600}, {824, 240}
});
...
const ConvoyData cd2[] = {
    ...
    {90,  TextureId::Alien13, 30, &hang_left,       false, true},
    {90,  TextureId::Alien14, 20, &hang_right,      false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};
...
const ConvoyData cd4[] = {
    ...
    {90,  TextureId::Alien14, 30, &horseshoe,       false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};

// STAGE 5: Theatrical 4-Corner Diagonal Ballet Incursion (Wave 5)
// After the dance, hordes dock on the outer Left (1) and Right (2) wings, leaving the center completely clear.
const ConvoyData cd5[] = {
    {0,   TextureId::Alien5,  35, &ballet_x_top_left,     false, false, false, 1},
    {0,   TextureId::Alien5,  35, &ballet_x_top_right,    false, false, true,  2},
    {0,   TextureId::Alien5,  35, &ballet_x_bottom_left,  false, false, true,  1},
    {0,   TextureId::Alien5,  35, &ballet_x_bottom_right, false, false, true,  2},
    {90,  TextureId::Alien14, 30, &valkyrie,              false, true,  false, 0},
    {0, TextureId::None, 0, nullptr, false, false, false, 0}
};
...
const ConvoyData cd7[] = {
    ...
    {90,  TextureId::Alien14, 40, &valkyrie,        false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};
...
const ConvoyData cd9[] = {
    ...
    {70,  TextureId::Alien14, 30, &valkyrie,        false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};
...
const ConvoyData cd10[] = {
    ...
    {85,  TextureId::Alien10, 40, &scythe_left,      false, true},
    {85,  TextureId::Alien10, 40, &scythe_left,      true,  true},
...
const ConvoyData cd11[] = {
    ...
    {80,  TextureId::Alien14, 45, &acrobatic_right, false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};
...
const ConvoyData cd13[] = {
    ...
    {75,  TextureId::Alien13, 45, &scythe_left,     false, true},
    {75,  TextureId::Alien13, 45, &scythe_left,     true,  true},
    {75,  TextureId::Alien4,  45, &butterfly_left,  false, false},
    {75,  TextureId::Alien5,  45, &butterfly_right, false, false},
    {75,  TextureId::Alien14, 45, &cobra,           false, true},
    {75,  TextureId::Alien13, 45, &hang_left,       false, true},
    {75,  TextureId::Alien13, 45, &hang_right,      false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};
...
const ConvoyData cd14[] = {
    ...
    {60,  TextureId::Alien2,  40, &scythe_left,              false, true},  // Dual diagonal relativistic cross
    {75,  TextureId::Alien3,  45, &acrobatic_left,           false, false},
...
const ConvoyData cd15[] = {
    ...
    {90,  TextureId::Alien15, 45, &acrobatic_right,  false, true},
    {80,  TextureId::Alien13, 40, &scythe_left,      false, false},
    {75,  TextureId::Alien12, 40, &scythe_left,      true,  false},
    {80,  TextureId::Alien14, 35, &valkyrie,         false, true},
    {0, TextureId::None, 0, nullptr, false, false}
};
...
size_t GetTotalLevels() { return static_cast<size_t>(GameRules::Progression::kWavesPerStage); }

size_t GetConvoyCount(size_t level_number) noexcept {
  // Deep DRY: delegates directly to compile-time StageCatalog SSOT
  return static_cast<size_t>(
      GameRules::StageCatalog::GetProfile(static_cast<int>(level_number)).convoy_count);
}
