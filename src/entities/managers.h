...
class AliensManager {
  ...
  static constexpr int kRandomWanderers = GameRules::Fleet::kRandomWanderersCount;
...
class Player : public Sprite {
  ...
  int shield_{GameRules::Player::kInitialShield};
  int speed_level_{0};
  int fire_level_{0};
  int fire_wait_{0};
  ...
  int hit_timer_{0};
  static constexpr int kMaxHitTimer = GameRules::Player::kMaxHitTimer;
