...
class SoundManager {
 ...
 private:
  ...
  static constexpr size_t RING_BUFFER_CAPACITY = GameRules::Audio::kRingBufferCapacity;
  ...
  const int sample_rate_{GameRules::Audio::kSampleRate};
  ...
  static constexpr size_t MAX_VOICES = GameRules::Audio::kMaxVoices;
